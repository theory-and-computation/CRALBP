...
if __name__ == '__main__':
    ...
    POPC_con_pocket, POPS_con_pocket = getContacts(104, 109)

    POPC_rt_pocket = calcResidenceTimes(POPC_con_pocket, 90000)
    POPS_rt_pocket = calcResidenceTimes(POPS_con_pocket, 90000)

    POPC_mrt = calculateMeanResidenceTime(POPC_rt_pocket)
    POPS_mrt = calculateMeanResidenceTime(POPS_rt_pocket)

    plotMean(POPC_mrt, POPS_mrt, sem(POPC_rt_pocket), sem(POPS_rt_pocket))
