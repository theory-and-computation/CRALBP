...
#SBATCH -o log/3hy5_lowerpore-umb-%d.out          # Name of stdout output file
...
export basename='3hy5_refmac1-ions-wats'
...
# Run NAMD
namd3 +p29 +pmepes 5 +setcpuaffinity +devices 0,1,2,3 umb_lp-%d.conf > log/'lp_'${basename}-${window}.log   # with 8 PEs per non-PME
