...
#SBATCH -o log/3hy5_upperpore-umb-%d.out          # Name of stdout output file
...
# Run NAMD
namd3 +p29 +pmepes 5 +setcpuaffinity +devices 0,1,2,3 umb_up-%d.conf > log/'up_'${basename}-${window}.log   # with 8 PEs per non-PME
