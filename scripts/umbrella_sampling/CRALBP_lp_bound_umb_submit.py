...
#SBATCH -o log/bound_lowerpore-umb-%d.out          # Name of stdout output file
...
export rundir=$basedir'/lp_'${basename}-${window}
export output=$rundir'/lp_'${basename}-${window}
...
# Run NAMD
namd3 +p29 +pmepes 5 +setcpuaffinity +devices 0,1,2,3 umb_b_lp-%d.conf > log/'lp_'${basename}-${window}.log   # with 8 PEs per non-PME
