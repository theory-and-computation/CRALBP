...
# Run NAMD
namd3 +p29 +pmepes 5 +setcpuaffinity +devices 0,1,2,3 umb_b_up-%d.conf > log/'up_'${basename}-${window}.log   # with 8 PEs per non-PME
...
#3.967667579650879 -4.0182716846466064 9.202869415283203
