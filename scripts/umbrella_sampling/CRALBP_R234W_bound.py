...
#SBATCH -o log/R234W_lowerpore-umb-%d.out          # Name of stdout output file
...
export basename='R234W-POPS-bound'
...
#export rstname=$basedir'/lp_'${basename}-${window}'/lp_'${basename}-${window}'.restart'

export rundir=$basedir'/'${basename}-${window}
export output=$rundir'/'${basename}-${window}
...
# Run NAMD
namd3 +p29 +pmepes 5 +setcpuaffinity +devices 0,1,2,3 234_b_lp-%d.conf > log'/'${basename}-${window}.log   # with 8 PEs per non-PME
