...
#SBATCH -o log/3hy5_sidepore-umb-%d.out          # Name of stdout output file
...
# Run NAMD
namd3 +p29 +pmepes 5 +setcpuaffinity +devices 0,1,2,3 umb_sp-%d.conf > log/'sp_'${basename}-${window}.log   # with 8 PEs per non-PME
