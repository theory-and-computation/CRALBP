...
#SBATCH -J rcm2-1  # Job name
#SBATCH -o log/rotatedSmallChargedMembrane_2-ions-wats-1.out          # Name of stdout output file

export jobstep='00001'
...
export langPistPeriod='500'
export langPistDecay='250'
export rstFreq='1000'
