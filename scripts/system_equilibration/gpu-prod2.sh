...
#SBATCH -J rcm2_2  # Job name
#SBATCH -o log/rotatedSmallChargedMembrane_2-ions-wats-2.out          # Name of stdout output file

export jobstep='00002'
export prev_jobstep='00001'
