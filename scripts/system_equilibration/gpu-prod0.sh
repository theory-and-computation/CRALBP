...
#SBATCH -J rcm2_0  # Job name
#SBATCH -o log/rotatedSmallChargedMembrane_2-ions-wats-0.out          # Name of stdout output file
...
#Line just for this job
export rstname=$basedir'/'${basename}-${jobstep}'/'${basename}-${jobstep}'.restart'
...
export langPistPeriod='1000'
export langPistDecay='500'
export rstFreq='100'
